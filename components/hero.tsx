      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl animate-fade-up">
            ...
            <h1 className="font-heading text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-[3.5rem] xl:text-6xl text-balance leading-[1.1] animate-fade-up opacity-0-initial delay-200">
              Топливные расходы{" "}
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl animate-fade-up opacity-0-initial delay-300">
              NevaCart — корпоративные топливные карты для компаний с автопарком.
          ...
          <div className="relative flex items-center justify-center lg:justify-end animate-fade-up opacity-0-initial delay-300">
            <div className="relative w-full max-w-md">
              ...
              {/* Main card */}
              <div className="relative rounded-3xl bg-foreground p-8 text-primary-foreground shadow-2xl shadow-foreground/20 animate-card-tilt">
                <div className="flex items-center justify-between mb-10">
                  <span className="font-heading text-lg font-bold tracking-wide">NevaCart</span>
                  <CreditCard className="h-8 w-8 opacity-40" />
                </div>

                {/* Chip */}
                <div className="mb-8 w-12 h-9 rounded-md bg-gradient-to-br from-amber-300/60 to-amber-500/40" />

                <div className="mb-8 flex gap-4 text-xl tracking-[0.25em] font-mono opacity-70">
                  <span>4276</span>
                  <span>****</span>
                  <span>****</span>
                  <span>8901</span>
              ...
              {/* Floating stats */}
              <div className="absolute -top-4 -right-4 lg:-right-8 rounded-2xl glass border border-border/60 p-4 shadow-xl animate-float delay-200">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10">
                    <TrendingDown className="h-5 w-5 text-emerald-600" />
                  </div>
                  <div>
                    <p className="text-[11px] text-muted-foreground font-medium">Экономия</p>
                    <p className="text-lg font-bold font-heading text-foreground">-15%</p>
                  </div>
                </div>
              </div>

              <div className="absolute -bottom-3 -left-4 lg:-left-8 rounded-2xl glass border border-border/60 p-4 shadow-xl animate-float delay-500">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10">
                    <MapPin className="h-5 w-5 text-primary" />
                  </div>
                  <div>
                    <p className="text-[11px] text-muted-foreground font-medium">АЗС в сети</p>
                    <p className="text-lg font-bold font-heading text-foreground">25 000+</p>
                  </div>
                </div>
              </div>

              <div className="absolute top-1/2 -left-2 lg:-left-12 -translate-y-1/2 rounded-2xl glass border border-border/60 p-4 shadow-xl animate-float delay-300">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-accent/10">
                    <ShieldCheck className="h-5 w-5 text-accent" />
                  </div>
                  <div>
                    <p className="text-[11px] text-muted-foreground font-medium">Защита</p>
                    <p className="text-lg font-bold font-heading text-foreground">24/7</p>
                  </div>
                </div>
              </div>
            </div>
